                    ...
                    <DropdownMenu>
                      <DropdownMenuTrigger asChild>
                        <Button variant="ghost" className="flex items-center gap-2 h-8 xl:h-10 hover:bg-red-900/20 transition-colors px-2">
                          ...
                          {user.role === 'admin' && <Badge className="bg-green-900/30 text-green-300 text-xs hidden xl:block">Admin</Badge>}
                        </Button>
                      </DropdownMenuTrigger>
              ...
              <SheetContent side="right" className="w-80 overflow-y-auto">
                ...
                <div className="flex flex-col space-y-4 mt-8 pb-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Link to={createPageUrl('LiveTV')} onClick={closeMobileMenu} className={`flex items-center gap-2 text-base font-medium p-3 rounded hover:bg-gray-800 ${language === 'kn' ? 'font-kannada' : ''}`}>
                      <Radio className="w-4 h-4" />
                      {language === 'kn' ? 'ಲೈವ್ ಟಿವಿ' : 'Live TV'}
                      <Badge className="bg-red-600 text-white text-xs px-1.5 py-0.5 ml-1 animate-pulse">LIVE</Badge>
                    </Link>
